package com.youme.naya.documentscanner.ui
...
//import com.youme.naya.documentscanner.R
import com.youme.naya.documentscanner.extensions.drawCheck
...
class DoneButton(context: Context, attrs: AttributeSet) : AppCompatImageButton(context, attrs) {
  ...
  init {
    ...
    ring.strokeWidth = resources.getDimension(com.websitebeaver.documentscanner.R.dimen.large_button_ring_thickness)

    // set inner circle style
    circle.color = ContextCompat.getColor(context, com.websitebeaver.documentscanner.R.color.done_button_inner_circle_color)
  ...
  override fun onDraw(canvas: Canvas) {
    ...
    val innerRadius = outerRadius - resources.getDimension(com.websitebeaver.documentscanner.R.dimen.large_button_outer_ring_offset)
