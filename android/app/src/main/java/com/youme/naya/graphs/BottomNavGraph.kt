...
//            CameraScreen()
        ...
        // Nuya 나야 카드 생성 (직접 입력)
        composable(route = "nuyaCreate/NayaCard") {
            NuyaCardCreateScreen(navController = navController, kind = 0)
        }
        // Nuya 명함 생성 (직접 입력)
        composable(route = "nuyaCreate/BCard") {
            NuyaCardCreateScreen(navController = navController, kind = 1)
        }
        // Nuya 카드 상세 정보
