...
import com.youme.naya.documentscanner.constants.DefaultSetting
import com.youme.naya.documentscanner.constants.DocumentScannerExtra
import com.youme.naya.documentscanner.extensions.move
import com.youme.naya.documentscanner.extensions.onClick
import com.youme.naya.documentscanner.extensions.saveToFile
import com.youme.naya.documentscanner.extensions.screenWidth
import com.youme.naya.documentscanner.models.Document
import com.youme.naya.documentscanner.models.Quad
import com.youme.naya.documentscanner.ui.ImageCropView
import com.youme.naya.documentscanner.utils.CameraUtil
import com.youme.naya.documentscanner.utils.FileUtil
import com.youme.naya.documentscanner.utils.ImageUtil
...
class DocumentScannerActivity : AppCompatActivity() {
    ...
    CameraUtil(
      ...
      onPhotoCaptureSuccess = {
        ...
        if (documents.size == maxNumDocuments - 1) {
          val newPhotoButton: ImageButton = findViewById(com.websitebeaver.documentscanner.R.id.new_photo_button)
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContentView(com.websitebeaver.documentscanner.R.layout.activity_image_crop)
    imageView = findViewById(com.websitebeaver.documentscanner.R.id.image_view)
    ...
    val newPhotoButton: ImageButton = findViewById(com.websitebeaver.documentscanner.R.id.new_photo_button)
    val completeDocumentScanButton: ImageButton = findViewById(com.websitebeaver.documentscanner.R.id.complete_document_scan_button)
    val retakePhotoButton: ImageButton = findViewById(com.websitebeaver.documentscanner.R.id.retake_photo_button)
  ...
  private fun cropDocumentAndFinishIntent() {
    ...
    setResult(RESULT_OK, Intent().putExtra("croppedImageResults", croppedImageResults))
    finish()
  }
  ...
  private fun finishIntentWithError(errorMessage: String) {
    setResult(RESULT_OK, Intent().putExtra("error", errorMessage))
    finish()
  }
}
